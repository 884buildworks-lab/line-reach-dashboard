...
export default function DataTable({ data, excludedIds, onExcludedChange }: DataTableProps) {
  ...
  const handleSelectAll = () => {
    ...
    data.forEach(item => {
      onExcludedChange(item.municipality_code, newSelectAll);
    });
  };
            ...
            <tr>
              <th className="px-6 py-4 text-left">
                <input
                  ...
                  className="rounded border-white/30 bg-white/20 text-purple-600 focus:ring-purple-500 focus:ring-offset-0 cursor-pointer"
                />
              </th>
              <th
